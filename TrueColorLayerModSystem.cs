...
namespace TrueColorLayer
{
    ...
    public class AccurateColorMapLayer : RGBMapLayer
    {
        ...
        {
            this.Active = false;
            capi = api as ICoreClientAPI ?? throw new InvalidOperationException("AccurateColorMapLayer requires client-side API");
